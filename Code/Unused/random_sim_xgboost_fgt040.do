...
if (`iter'==1){
	...
	keep hhid HID_mun HID hhsize $toimport poor_40 gap_40 gap2_40 e_y lny
...
*===============================================================================
	gen observations=1
	groupfunction [aw=popw],mean(poor_40 gap_40 gap2_40 e_y) rawsum(observations) by(HID_mun)
	gen nsim = `iter'
	gen nsample = `sample'
