...
model = ['gb_census_mun', 'gb_gis_mun', 'gb_all_mun', 'gb_census_psu',  
         ...
         'ols_census_mun', 'ols_gis_mun', 'ols_all_mun', 'ols_census_psu', 'gb_census_hh']
for i in model:
...
mse.columns = ['muni', 'mse_gb_census',' mse_gb_gis', 'mse_gb_all', 'mse_gb_psu',
               ...
               'mse_ols_census', 'mse_ols_gis', 'mse_ols_all', 'mse_ols_psu', 'mse_gb_hh',
               'mse_eb', 'mse_uc']
bias.columns = ['muni', 'bias_gb_census',' bias_gb_gis', 'bias_gb_all', 'bias_gb_psu',
               ...
               'bias_ols_census', 'bias_ols_gis', 'bias_ols_all', 'bias_ols_psu', 'bias_gb_hh',
               'bias_eb', 'bias_uc']
