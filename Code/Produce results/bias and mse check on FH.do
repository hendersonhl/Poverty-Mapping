...
merge 1:m HID_mun using "$outpath\FH_results_mun_gis.dta", keepusing(fh_fgt0)
rename fh_fgt0 estimate
...
save "$outpath\fh_mun_gis_mse_bias.dta", replace
