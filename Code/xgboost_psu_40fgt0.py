# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 09:06:50 2022

@author: Paul Corral

This file runs the same XGboost but for a poverty line that yields 40% poverty
"""
...
prediction.to_csv(outpath + 'gb_census_psu(disaggregated)_40.csv', index = False)
...
# Save results
prediction.to_csv(outpath + 'gb_census_psu_40.csv')
importance.to_csv(outpath + 'gb_importance_census_psu_40.csv', index = False)
